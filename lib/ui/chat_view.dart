...
import 'package:cmtchat_app/views/home/message_thread/receiver_message.dart';
import 'package:cmtchat_app/views/home/message_thread/sender_message.dart';
    ...
    return Container(
        ...
        child: Row(children: [
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Padding(
              padding: const EdgeInsets.only(left: 8.0),
              child: Text(receiver.active ?? false ? 'online' : 'offline',
                  style: Theme.of(context).textTheme.bodySmall),
            ),
          ]),
        ])
